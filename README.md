...
<table><tr>
    ...
    <td>
      <a href="https://github.com/conda-forge/libwebsockets-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/libwebsockets-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
...
pixi add libwebsockets
# for installing globally
pixi global install libwebsockets
```
...
It is possible to list all of the versions of `libwebsockets` available on your platform:
...
```
pixi search libwebsockets --channel conda-forge
```
